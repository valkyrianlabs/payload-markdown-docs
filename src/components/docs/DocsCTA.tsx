...
const normalizeVariant = (variant: DocsCTAProps['variant']): DocsCTAVariant => variant ?? 'normal'

const normalizeGradient = (gradient: DocsCTAProps['gradient']): DocsCTAGradient =>
  gradient ?? 'brand'

const panelClasses: Record<DocsCTAVariant, string> = {
...
const contentClasses: Record<DocsCTAVariant, string> = {
...
const descriptionClasses: Record<DocsCTAVariant, string> = {
...
const skillsGridClasses: Record<DocsCTAVariant, string> = {
...
const skillLinkClasses: Record<DocsCTAVariant, string> = {
  full:
...
const skillDescriptionClasses: Record<DocsCTAVariant, string> = {
...
export const DocsCTA = ({
  ...
  const resolvedTitle = contentIsOverridden
    ? getText(heading)
    : getDocsSetTitle(docsSet) ?? getText(heading)
