...
_SEMANTIC_TOPIC_PRIORITY: dict[str, int] = {
    ...
    "documentation sync behavior": 12,
    "Payload plugin behavior": 13,
    "admin UI behavior": 14,
    "frontend rendering behavior": 15,
    "generated docs and agent assets": 16,
    "documentation content": 17,
    "database integration behavior": 18,
    "service lifecycle handling": 19,
