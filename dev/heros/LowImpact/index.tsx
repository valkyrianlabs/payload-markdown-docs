...
export const LowImpactHero: React.FC<DevHeroProps> = ({ description, heading }) => (
  <section className="px-6 py-16">
    <div className="mx-auto max-w-5xl border-l border-cyan-300/45 pl-6">
      ...
      {description ? <p className="mt-4 max-w-2xl text-base text-foreground/70">{description}</p> : null}
    </div>
  </section>
)
